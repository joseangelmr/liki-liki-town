...
public class PanelGlassGaussian extends JComponent {
	...
	public void setVisible(boolean visible) {
		if (visible) {
			if (!dialogo)
				backDrop = GraphicsUtilities.createCompatibleImage(mainFrame
						.getRootPane().getWidth(), mainFrame.getRootPane()
						.getHeight());
			else
				backDrop = GraphicsUtilities.createCompatibleImage(mainDialog
						.getRootPane().getWidth(), mainDialog.getRootPane()
						.getHeight());
